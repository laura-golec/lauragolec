...
function About() {
    ...
    return (
        <div className='about' style={{justifycontent:'center', height:'calc(100% - 90px)', boxsizing:'border-box'}}>
            ...
            <div className='aboutContent' style={{ maxWidth: '800px', paddingBottom: '5vh'}}>
